...
class PairwiseTruncatedQuadraticEnvelope :
    public PairwiseCostsEnvelope<COSTTYPE, SIMDWIDTH, UNARY, PAIRWISE>
{
public:
    PairwiseTruncatedQuadraticEnvelope(const PairwiseTruncatedQuadratic<COSTTYPE,
        SIMDWIDTH> * base);
...
template<typename COSTTYPE, uint_t SIMDWIDTH, typename UNARY, typename PAIRWISE>
using PairwiseTruncatedQuadraticEnvelope_ptr =
    std::unique_ptr<PairwiseTruncatedQuadraticEnvelope<COSTTYPE, SIMDWIDTH,
    UNARY, PAIRWISE>>;
