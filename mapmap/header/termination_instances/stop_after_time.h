...
#ifndef __MAPMAP_HEADER_TERMINATION_INSTANCES_STOP_AFTER_TIME_H_
#define __MAPMAP_HEADER_TERMINATION_INSTANCES_STOP_AFTER_TIME_H_
...
#endif /* __MAPMAP_HEADER_TERMINATION_INSTANCES_STOP_AFTER_TIME_H_ */
